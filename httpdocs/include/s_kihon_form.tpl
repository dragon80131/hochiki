...
<button type='button' onClick='moveWithKey( "s_kihon_copy.php?rKey=__rKey__" , __editBukkenCD__);' class='btn btn-info btn-xs' style='margin:5px 0px'>過去物件情報からコピー</button>
...
<!--
<tr><th class="yb">管理No<font color="red">※</font></th>
-->
	<!--
	<td><input type="text" name="ins_MitumoriNo" value="__ins_MitumoriNo__" size="10"></td></tr>
	-->
	<!--
	<td><input type="text" name="wKenmeiNo" value="__wKenmeiNo__" size="10"></td></tr>
	-->
<tr><th class="yb">物件名<font color="red">　※</font></th>
<td><input type="text" name="wBukkenName" value="__wBukkenName__" style="width:400px;" placeholder="例：○○マンション"></td></tr>

<tr><th class="yb">物件名(ふりがな)</th>
	<td><input type="text" name="wBukkenName_Hurigana" value="__wBukkenName_Hurigana__" style="width:400px;"></td></tr>

<tr><th class="yb">住所<font color="red"> ※</font></th>
	<td><input type="text" name="wAddress" id="Addressid" value="__wAddress__" style="width:400px;"></td></tr>
<tr><th class="yb">住戸数<font color="red">　※</font></th>
	<td><input type="text" name="wKosu" value="__wKosu__" style="width:80px; ime-mode:disabled;"> 戸</td></tr>
<tr><th class="yb">階高<font color="red">　※</font></th>
	<td><input type="text" name="wKaidaka" value="__wKaidaka__" style="width:80px; ime-mode:disabled;"> 階</td></tr>
<tr><th class="yb">会社名<font color="red">　※</font></th>
	<td><input type="text" name="wKojiShozokuName" value="__wSekoShutai__" style="width:400px;"></td></tr>
<tr><th class="yb">会社TEL<font color="red">　※</font></th>
	<td><input type="text" name="wKojiShozokuTEL" value="__wKojiShozokuTEL__" style="width:150px;"></td></tr>
<tr><th class="yb">担当名<font color="red">　※</font></th>
	<td><input type="text" name="wKojiTantoName" value="__wKojiTantoName__" style="width:300px;"></td></tr>
...
<tr><th class="yb">専有部<font color="red">　※</font></th>
	<td>
...
<table class="table table-bordered table-sm" id="" style="width: 800px">
	...
	<tr><th class="yb">基本システム</th>
	<td><select name="wRNsystem" >
		__RNsystemLoop__ <option value="__RNSYSTEM_Value__" __RNsystemSelected__ >__RNSYSTEMNAME__</option> __RNsystemLoop__
		</select>
	</td></tr>
	<tr><th class="yb">室内親機品番</th>
		<td>
...
◆オプション工事　
<p id="maxno_op_nondisp" style="display:none">__maxno_op_nondisp__</p><!--行追加用-->
...
<style><!--
<tr><th class="yb">オプション支払い方法</th>
	<td colspan="2">
		<font size="2" color="gray">※オプション登録時、選択可</font><br>
		<span id="Shiharai_id" style="color:lightgray;">
			<input type="checkbox" name="wShiharai[]" value="現金" __ShiharaiSelected1__ >現金　<br>
			<input type="checkbox" name="wShiharai[]" value="振込" __ShiharaiSelected2__ >振込　<br>
			<input type="checkbox" name="wShiharai[]" value="NP"   __ShiharaiSelected3__ >コンビニ・郵便局・銀行(NP後払い）　<br>
			<input type="checkbox" name="wShiharai[]" value="コンビニ" __ShiharaiSelected4__ onchange="changeShiharaiConveni();" >コンビニ払込票支払
			<span id="wShiharaiConveniFont" style="color:lightgray;">
				( <input type="radio" name="wShiharaiConveni" value="0" __ShiharaiConveni0__ >通常　
				  <input type="radio" name="wShiharaiConveni" value="1" __ShiharaiConveni1__ >上限54000円税込　）
			</span>
		</span>
	</td></tr>
<tr><th class="yb">オプション受付方法</th>
	<td colspan="2">
		<font size="2" color="gray">※オプション登録時、選択可</font><br>
		<span id="OPUketukei_id" style="color:lightgray;">
			<input type="radio" name="wOPUketuke" value="0" __OPUketukeChecked0__ >日程受付と同じフリーダイヤル　<br>
			<input type="radio" name="wOPUketuke" value="2" __OPUketukeChecked2__ >フリーダイヤルとWEB受付　<!--未着手--><br>
...
<input type="hidden" name="touroku_btn" id="touroku_btn" value=""><!--登録ボタン押下後、エラーなしの場合に設定する-->
</form>
...
function form_check(val) {
	...
	*/
	if (!chk_input("wKojiShozokuName")) html.push("所属名が入力されていません。");
	if (!chk_input("wKojiShozokuTEL")) html.push("所属TELが入力されていません。");
