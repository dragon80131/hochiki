<?php
	...
	*/		if($n<=$i){
	...
	$Koteihyou="<table border='1' width='600px' style='text-align:center'><tr><td>日程</td><td>曜日</td><td colspan = ".$wWakuAMcol." style='background-color:#ff7f50;'>AM</td>";
	if($wWakuPattern <= 2){
		$Koteihyou .="<td colspan = ".$wWakuPM1col." style='background-color:#87cefa'>PM</td></tr>";
		$wWakuPM2col = 0;
	}else{
		$Koteihyou .="<td colspan = ".$wWakuPM1col." style='background-color:#87cefa'>PM1</td><td colspan = ".$wWakuPM2col." style='background-color:#99FF66;'>PM2</td></tr>";
	}
	...
	for($i=0 ; $i< $SenyuDateCnt ; $i++){
		...
		if(array_search($i,$wKyukobi)!==false && $wKyukobi[$i]!==""){
			$Koteihyou .="<tr><td rowspan =1".$wShukujitucolor[$i].">".$SenyuDate."</td>";
			$Koteihyou .="<td rowspan =1".$wShukujitucolor[$i].">".$Youbi."</td>";
		...
		#★１休工日でない場合
			...
			$Koteihyou .="<tr><td rowspan =".$wHansu.$wShukujitucolor[$i].">".$SenyuDate."</td>";
			$Koteihyou .="<td rowspan =".$wHansu.$wShukujitucolor[$i].">".$Youbi."</td>";
