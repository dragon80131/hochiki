...
foreach($beforeReserveDay as $key => $aReserveDay){
	...
	if ($beforeKojiHoliday[$key]) { #★１休工日なら
		if ($beforeHoliday[$key]) { //土日祝なら
			$Koteihyou .= "<tr class='trtop trreserveday'><td class='ex_table2' style='background-color:pink;'>" . $SenyuDate . "<div class='reserve_day'>予備日</div></td>";
		...
		if ($beforeHoliday[$key]) { //土日祝なら
			$Koteihyou .= "<tr class='trtop trreserveday'><td rowspan=" . $rowCountforDay . " class='ex_table2' style='background-color:pink;'>" . $SenyuDate . "<div class='reserve_day'>予備日</div></td>";
