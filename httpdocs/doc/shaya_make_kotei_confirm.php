...
#★1	専有部工事日でまわす
	...
	*/	
	...
	$Koteihyou="<table border='3' width='600px' style='text-align:center'><tr><td>日程</td><td>曜日</td><td colspan = ".$wWakuAMcol." style='background-color:#ff7f50;'>AM</td>";
	if($wWakuPattern <= 2){
...
#							echo "<br>PM2:".$n;
	...
	$CNT_FILE = "shaya_make_kanryo_confirm.tpl";
