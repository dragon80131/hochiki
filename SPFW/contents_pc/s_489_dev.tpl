	...
	<script>
		...
		function checkInput() {
			...
			if (error_flg) {
				...
				document.mainform.action = "s_489_confirm_dev.php?rKey=__rKey__&editBukkenCD=__editBukkenCD__";
				document.mainform.submit();
			}
		}
...
<body onload="initOnload();">
	...
	<div class="content-all">
		...
		<div class="top-menu left-yose">
			...
			<form action="s_489_confirm_dev.php" method="POST" name="mainform">
				...
				<table class="table table-bordered table-sm">
					...
					<tr id="EntrancePIN" style="display:none;">
						...
						<td>
							<input type="number" name="wEntrancePIN" value="__wEntrancePIN__" min="0">
						</td>
					</tr>
