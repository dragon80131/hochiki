...
<table class="sampleTable"><!--テーブル①-->
<tr><td class="nondisp">
<a href="s_list.php__QUERY__">＞＞＞物件一覧</a><br>
__IfKanri__
<a href="#" onclick="javascript:moveWithSagyoinCD('s_sagyoin.php', 0 );">＞＞＞物件工程修正（対象月を表示してからクリック）</a> <br>
...
<td  bgcolor="lightgreen" rowspan="2" class="nondisp" ></td>
...
<td  bgcolor="lightgreen"  class="nondisp" ></td>
