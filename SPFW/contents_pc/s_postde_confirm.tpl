...
<form action="s_postde_finish.php" method="POST" name="mainform" enctype="multipart/form-data">
...
<tr>
	...
	<td bgcolor="lemonchiffon">
		<img src="__upload_file__" width="314">
...
<tr>
	...
	<td bgcolor="lemonchiffon">
		__kojiwaku__<input type="hidden" name="kojiwaku" value="__kojiwaku__">
	</td>
</tr>
<tr>
	<th bgcolor="lightgrey">
	...
	<td bgcolor="lemonchiffon">
		__kojijunName__<input type="hidden" name="kojijun" value="__kojijun__">
	</td>
</tr>
<tr>
	<th bgcolor="lightgrey">
	...
	<td bgcolor="lemonchiffon">
		__Notes__<input type="hidden" name="Notes" value="__Notes__">
	</td>
</tr>
</table></center>
...
<input type="hidden" name="dataName" value="__dataName__">
<input type="hidden" name="extension" value="__extension__">
