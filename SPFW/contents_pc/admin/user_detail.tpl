...
<div class="content">
<h2 class="admin-title">会員管理 − 詳細情報フォーム__ExtraTitle__</h2>
<br />

__IfNormal__<h2 class="navigation"><a href="javascript:history.back();">&lt;&lt;&lt; 会員リストへもどる</a></h2>
...
__IfNormal____IfReserve__<h2 class="navigation"><a href="#" onclick="javascript:window.close();">&lt;&lt;&lt; 閉じる</a></h2>
__IfReserve__
<br />

<form method="POST" action="user_list.php" name="mainform">

__IfReserveSystem__<a href="#ReserveList" onclick="javascript:toggle('Reserve', 'show');">&gt; __ReservationName__履歴</a>　　　
__IfReserveSystem____IfCoupon__<a href="#CouponLogList" onclick="javascript:toggle('CouponLog', 'show');">&gt; クーポン利用履歴</a>
__IfCoupon__<table class="common-list" width="700">
	<tr id="blockName">
		<td nowrap class="common-list-title" colspan="2">管理データ</td>
	</tr>
	<tr id="blockName">
		<td nowrap class="common-list-title" width="200">会員コード</td>
		<td nowrap class="common-list-value-left">
			__wUserCD__　(システムが決定しているので変更できません)
		</td>
	</tr>
	<tr id="blockJoined">
		<td nowrap class="common-list-title" width="200">ステータス</td>
		<td nowrap class="common-list-value-left" valign="middle">
			__pStatus__　　　
			__IfJoin__<input type="button" value="退会扱いにする" onclick="javascript:moveWithWork('user_list.php', 2)">__IfJoin__
			__IfWithdraw__<input type="button" value="入会扱いにする" onclick="javascript:moveWithWork('user_list.php', 3)">__IfWithdraw__
		</td>
	</tr>
__IfDependsOnAccount__	<tr>
		<td nowrap class="common-list-title" width="200">所属空メール</td>
		<td nowrap class="common-list-value-left">
			<select name="wAccountCD" class="select">
__AccountListLoop__			<option value="__AccountCD__"__AccountSelected__>__AccountName__</option>
__AccountListLoop__			</select>
		</td>
	</tr>
__IfDependsOnAccount__<!--	<tr id="blockJoined">
		<td nowrap class="common-list-title" width="200">入会日</td>
		<td nowrap class="common-list-value-left">
			__wJoined__
		</td>
	</tr>
	<tr id="blockJoined">
		<td nowrap class="common-list-title" width="200">退会日</td>
		<td nowrap class="common-list-value-left">
			__wWithdrawn__
		</td>
	</tr>-->
	<tr id="blockName">
		<td nowrap class="common-list-title" width="200">キャリア・ブラウザ</td>
		<td class="common-list-value-left">
			【__wCarrier__】&nbsp;&nbsp;&nbsp;&nbsp;__wUserAgent__
		</td>
	</tr>
__IfUID__<!--	<tr id="blockName">
		<td nowrap class="common-list-title" width="200">端末識別子</td>
		<td nowrap class="common-list-value-left">
			__UID__
		</td>
	</tr>-->
__IfUID__<!--	<tr id="blockName">
		<td nowrap class="common-list-title" width="200">登録用URL</td>
		<td nowrap class="common-list-value-left">
			__MAIN_URL__form.php?rKey=__RegistKey__
		</td>
	</tr>
	<tr id="blockName">
		<td nowrap class="common-list-title" width="200">トップページURL</td>
		<td nowrap class="common-list-value-left">
			__MAIN_URL__top.php?rKey=__RegistKey__
		</td>
	</tr>-->
__IfPoint__	<tr id="blockName">
		<td nowrap class="common-list-title" width="200">ポイント</td>
		<td nowrap class="common-list-value-left">
...
__IfID__	<tr id="blockName">
		<td nowrap class="common-list-title" width="200">__IDName__</td>
		<td nowrap class="common-list-value-left">
			<input type="text" name="wID" value="__wID__" size="15" __IME_OFF__ class="form">
		</td>
	</tr>__IfID__
__IfPasswd__	<tr id="blockName">
		<td nowrap class="common-list-title" width="200">__PasswdName__</td>
		<td nowrap class="common-list-value-left">
			<input type="text" name="wPasswd" value="__wPasswd__" size="15" __IME_OFF__ class="form">
		</td>
	</tr>__IfPasswd__
__IfName__	<tr id="blockName">
__IfLastName__		<td nowrap class="common-list-title" width="200">__LastNameName__</td>
		<td nowrap class="common-list-value-left">
			<input type="text" name="wLastName" value="__wLastName__" size="20" __IME_ON__ class="form">
		</td>
	</tr>__IfLastName__
__IfFirstName__		<td nowrap class="common-list-title" width="200">__FirstNameName__</td>
		<td nowrap class="common-list-value-left">
			<input type="text" name="wFirstName" value="__wFirstName__" size="20" __IME_ON__ class="form">
		</td>
	</tr>__IfFirstName__
__IfLastNameKana__	<tr id="blockName">
		<td nowrap class="common-list-title" width="200">__LastNameKanaName__</td>
		<td nowrap class="common-list-value-left">
...
__IfFirstNameKana__	<tr id="blockName">
		<td nowrap class="common-list-title" width="200">__FirstNameKanaName__</td>
		<td nowrap class="common-list-value-left">
...
__IfGender__	<tr id="blockMukouFlg">
		<td nowrap class="common-list-title" width="200">__GenderName__</td>
		<td nowrap class="common-list-value-left">
__GenderLoop__
...
__GenderLoop__
	...
	<tr id="blockName">
		...
		<td nowrap class="common-list-value-left">
			<input type="text" name="wEMail" value="__wEMail__" size="40" __IME_OFF__ class="form">
			<font class="notice">※必須</font>
		</td>
	</tr>
__IfBirthday__	<tr id="blockName">
		<td nowrap class="common-list-title" width="200">__BirthdayName__</td>
		<td nowrap class="common-list-value-left">
...
__IfAddress__	<tr id="blockName">
		<td nowrap class="common-list-title" width="200">住所</td>
		<td nowrap class="common-list-value-left">
...
__IfTEL__	<tr id="blockName">
		<td nowrap class="common-list-title" width="200">__TELName__</td>
		<td nowrap class="common-list-value-left">
			<input type="text" name="wTEL" value="__wTEL__" size="20" maxlength="11" __IME_OFF__ class="form">
		</td>
	</tr>__IfTEL__

__IfQuestion1__				<tr>
					<td class="common-list-title" id="red">設問1</td>
					<td class="common-list-value-left">__Question1__<br>
__IfRadio1____Choice1Loop__					<input type="radio" name="wQuestion1" value="__Choice1Value__"__Choice1Checked__>__Choice1Name__<BR>
...
__IfQuestion2__				<tr>
					<td class="common-list-title" id="red">設問2</td>
					<td class="common-list-value-left">__Question2__<br>
__IfRadio2____Choice2Loop__					<input type="radio" name="wQuestion2" value="__Choice2Value__"__Choice2Checked__>__Choice2Name__<BR>
...
__IfCheckbox2____Choice2Loop__					<input type="checkbox" name="wQuestion2[]" value="__Choice2Value__"__Choice2Checked__>__Choice2Name__<BR>
__Choice2Loop____IfCheckbox2__
__IfSelect2__					<select name="wQuestion2">
...
__IfText2__					<input type="text" size="60" name="wQuestion2" value="__wQuestion2__"><BR>
__IfText2__
__IfTextarea2__					<textarea cos="50" rows="3" name="wQuestion2">__wQuestion2__</textarea><BR>
__IfTextarea2__
__IfDate2____IfAjax__			<input type="text" name="wQuestion2" id="wQuestion2" value="__wQuestion2__" size="14" maxlength="2" __IME_OFF__ class="form">
__IfAjax____IfNoAjax__			<input type="text" name="wQuestion2Year" value="__wQuestion2Year__" size="6" maxlength="4" __IME_OFF__ class="form"> 年 
			<input type="text" name="wQuestion2Month" value="__wQuestion2Month__" size="6" maxlength="2" __IME_OFF__ class="form"> 月 
			<input type="text" name="wQuestion2Day" value="__wQuestion2Day__" size="6" maxlength="2" __IME_OFF__ class="form"> 日
__IfNoAjax____IfDate2__
...
__IfQuestion3__				<tr>
					<td class="common-list-title" id="red">設問3</td>
					<td class="common-list-value-left">__Question3__<br>
...
__IfText3__
__IfTextarea3__					<textarea cos="50" rows="3" name="wQuestion3">__wQuestion3__</textarea><BR>
__IfTextarea3__
...
__IfQuestion4__				<tr>
					<td class="common-list-title" id="red">設問4</td>
					<td class="common-list-value-left">__Question4__<br>
...
__IfQuestion5__				<tr>
					<td class="common-list-title" id="red">設問5</td>
					<td class="common-list-value-left">__Question5__<br>
...
__IfText5__
__IfTextarea5__					<textarea cos="50" rows="3" name="wQuestion5">__wQuestion5__</textarea><BR>
__IfTextarea5__
...
__IfQuestion6__				<tr>
					<td class="common-list-title" id="red">設問6</td>
					<td class="common-list-value-left">__Question6__<br>
__IfRadio6____Choice6Loop__					<input type="radio" name="wQuestion6" value="__Choice6Value__"__Choice6Checked__>__Choice6Name__<BR>
...
__IfCheckbox6____Choice6Loop__					<input type="checkbox" name="wQuestion6[]" value="__Choice6Value__"__Choice6Checked__>__Choice6Name__<BR>
__Choice6Loop____IfCheckbox6__
__IfSelect6__					<select name="wQuestion6">
...
__IfText6__					<input type="text" size="60" name="wQuestion6" value="__wQuestion6__"><BR>
__IfText6__
__IfTextarea6__					<textarea cos="50" rows="3" name="wQuestion6">__wQuestion6__</textarea><BR>
__IfTextarea6__
__IfDate6____IfAjax__			<input type="text" name="wQuestion6" id="wQuestion6" value="__wQuestion6__" size="14" maxlength="6" __IME_OFF__ class="form">
__IfAjax____IfNoAjax__			<input type="text" name="wQuestion6Year" value="__wQuestion6Year__" size="6" maxlength="4" __IME_OFF__ class="form"> 年 
			<input type="text" name="wQuestion6Month" value="__wQuestion6Month__" size="6" maxlength="2" __IME_OFF__ class="form"> 月 
			<input type="text" name="wQuestion6Day" value="__wQuestion6Day__" size="6" maxlength="2" __IME_OFF__ class="form"> 日
__IfNoAjax____IfDate6__
...
__IfQuestion7__				<tr>
					<td class="common-list-title" id="red">設問7</td>
					<td class="common-list-value-left">__Question7__<br>
...
<!--	<tr id="blockName">
	...
	<tr id="blockMukouFlg">
		<td nowrap class="common-list-title" width="200">メルマガ購読</td>
		<td nowrap class="common-list-value-left">
__MailMagaFlgLoop__
...
__MailMagaFlgLoop__
	...
	<tr id="blockJoined">
		<td nowrap class="common-list-title" width="200">入会日</td>
		<td nowrap class="common-list-value-left">
__IfAjax__			<input type="text" name="wJoined" id="wJoined" value="__wJoined__" size="14" maxlength="10" __IME_OFF__ class="form">
__IfAjax____IfNoAjax__			<input type="text" name="wJoinedYear" value="__wJoinedYear__" size="6" maxlength="4" __IME_OFF__ class="form"> 年 
			<input type="text" name="wJoinedMonth" value="__wJoinedMonth__" size="6" maxlength="2" __IME_OFF__ class="form"> 月 
			<input type="text" name="wJoinedDay" value="__wJoinedDay__" size="6" maxlength="2" __IME_OFF__ class="form"> 日　
__IfNoAjax__			<input type="text" name="wJoinedHour" id="wJoinedHour" value="__wJoinedHour__" size="3" maxlength="2" __IME_OFF__ class="form"> 時
			<input type="text" name="wJoinedMinute" id="wJoinedMinute" value="__wJoinedMinute__" size="3" maxlength="2" __IME_OFF__ class="form">分
			<input type="text" name="wJoinedSecond" id="wJoinedSecond" value="__wJoinedSecond__" size="3" maxlength="2" __IME_OFF__ class="form">秒
		</td>
	</tr>
	<tr id="blockJoined">
		<td nowrap class="common-list-title" width="200">退会日</td>
		<td nowrap class="common-list-value-left">
__IfAjax__			<input type="text" name="wWithdrawn" id="wWithdrawn" value="__wWithdrawn__" size="14" maxlength="10" __IME_OFF__ class="form">
__IfAjax____IfNoAjax__			<input type="text" name="wWithdrawnYear" value="__wWithdrawnYear__" size="6" maxlength="4" __IME_OFF__ class="form"> 年 
			<input type="text" name="wWithdrawnMonth" value="__wWithdrawnMonth__" size="6" maxlength="2" __IME_OFF__ class="form"> 月 
			<input type="text" name="wWithdrawnDay" value="__wWithdrawnDay__" size="6" maxlength="2" __IME_OFF__ class="form"> 日　
__IfNoAjax__			<input type="text" name="wWithdrawnHour" id="wWithdrawnHour" value="__wWithdrawnHour__" size="3" maxlength="2" __IME_OFF__ class="form"> 時
			<input type="text" name="wWithdrawnMinute" id="wWithdrawnMinute" value="__wWithdrawnMinute__" size="3" maxlength="2" __IME_OFF__ class="form">分
			<input type="text" name="wWithdrawnSecond" id="wWithdrawnSecond" value="__wWithdrawnSecond__" size="3" maxlength="2" __IME_OFF__ class="form">秒
		</td>
	</tr>
	<!--<tr id="blockMukouFlg">
		<td nowrap class="common-list-title" width="200">会員区分</td>
		<td nowrap class="common-list-value-left">
__ClassificationLoop__
			<input type="radio" name="wUserType" value="__wClassificationValue__" __ClassificationChecked__>__Classification__　
__ClassificationLoop__
		</td>
	</tr>-->
	<tr id="blockName">
...
__ReservationLoop____IfReserveList____IfNoReserveList__
	<tr>
		<td nowrap class="common-list-value" colspan="12"><font color="red">当会員の__ReservationName__履歴はありません。</font></td>
	</tr>
...
__CouponLogLoop____IfCouponLogList____IfNoCouponLogList__
	<tr>
		<td nowrap class="common-list-value" colspan="12"><font color="red">当会員のクーポン利用履歴はありません。</font></td>
	</tr>
