<html>
<head>
<title>__ReservationName__システム設定 − メール設定完了</title>
...
<body>
<div class="content">
<h2 class="admin-title">__ReservationName__システム設定 − メール設定完了__ExtraTitle__</h2>
<br />
...
<table class="common-list">
	...
	<tr id="blockAction">
		<td nowrap class="common-list-value-left" colspan="2">
			<input type="button" value="もどる" class="button" onclick="javascript:move('index.php')">　　　
		</td>
	</tr>
</table>
