...
<input type="hidden" name="editBukkenCD" >
	...
	掲示用資料をダウンロードする場合でも、作業日時の入力をお願いします。
<br><br>
...
<!--		__If170__<input type="radio" name="format" value="1" onchange="RoomCheck();">170号・外部試験<br>
		...
		<span id="SyoboTypeEmpty"></span><br>
		　<a href="#" onclick="CheckandMove2('./s_syouboukensa_Excel.php?rKey=__rKey__&editBukkenCD=__editBukkenCD__&format=6');return false;" >掲示用資料</a>
	</td>
</tr>
</table>
<br>
