	...
	<div class="content-all">
		...
		<div class="top-menu left-yose">
			...
			<table class="table table-bordered table-sm" style="width: 1000px;">
				...
				<tr>
					<td><B>◆現調シート</B>　
						<a href=./upfile/imgup.php?SekoStatus=2&Device=11&rKey=__rKey__&BukkenCD=__editBukkenCD__>>>>写真/PDFファイル追加</a>　<b>png,jpg,gif,pdfのみ。</b></td>
				</tr>
				<tr>
					<td>
						<br>
				...
				<tr>
					<td bgcolor="#E6FFE9">
						<font size="4"><B>◆専有部</B></font>　

						<table class="table table-borderless" style="background-color:#E6FFE9">
							<tr>
								<td style="width:450px;">
									<a href="s_pic.php?rKey=__rKey__&editBukkenCD=__editBukkenCD__">画面更新</a><br>
									<table class="table table-borderless" style="width:450px; background-color:#78FF94">
										<tr>
											<td>
												<form action="d2b/upload_sf_pics.php?SekoStatus=2&Device=10&BukkenCD=__editBukkenCD__" class="dropzone"></form>
											</td>
										</tr>
									</table>
								</td>
								<td>
									<table>
										<tr>__PicSenyuLoop____PicSenyu____PicSenyuLoop__</tr>
									</table>
						</table>
					</td>
				</tr>
