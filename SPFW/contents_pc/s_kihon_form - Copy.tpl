...
<body>
  ...
  <div class="container">
      <div class="row mt-3">
		...
		__IfRegist__
	__IfSinki__
			<a href="s_menu.php?rKey=__rKey__&editBukkenCD=__editBukkenCD__&m=__m__" class="btn btn-info mb-1">メニュー</a>
			__IfWorker__
			__IfShowSchedule__
				...
				<form action="s_kihon_finish.php" method="POST" name="mainform" >
					...
					<table class="table table-bordered table-sm row-table">
						...
						<tr>
							...
							<td>
								<input class="full-width" type="text" name="wBukkenName" required value="__wBukkenName__" placeholder="例：○○マンション" v-model="bukkenname">
								<br />
						...
						<tr>
							...
							<td>
								<input class="full-width" type="text" name="wSagyoName" id="wSagyoName" value="__wSagyoName__" v-model="" required>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input class="full-width" type="text" name="wAddress" id="Addressid" value="__wAddress__" v-model="address" required>
							</td>
						</tr>
						<tr>
							<th class="yb">担当者</th>
						...
						<tr>
							...
							<td>
								<input type="text" name="SenyuStartDate" id="SenyuStartDate"  class="datepicker" value="__SenyuStartDate__" required>～
								<input type="text" name="SenyuEndDate" id="SenyuEndDate"  class="datepicker" value="__SenyuEndDate__" required>
						...
						<tr>
							...
							<td>
								...
								<input type="text" name="YoyakuEndDate"  id="YoyakuEndDate"  value="__YoyakuEndDate__" class="datepicker" required>
							</td>
						</tr>	
						<tr>
							<th class="yb">
							...
							<td>
								...
								<input type="text" name="MinuteTime" id="MinuteTime" value="__MinuteTime__" style="width: 80px;" required>分
					...
					<table class="table table-bordered table-sm row-table">
						...
						<tr>
							<th class="yb">棟名称・住戸数<font color="red">※</font>
							</th>
							<td>
								棟名称
								...
								&nbsp;
								住戸数(半角数字)
								<input type="number" name="wKosu" class="dwelling" value="__wKosu__" style="width: 80px; ime-mode: disabled" v-model="Kosu" required onchange="calcDwellingCount();">
								戸&nbsp;階高
								<input type="number" name="wKaidaka" value="__wKaidaka__" style="width: 80px; ime-mode: disabled" v-model="Kosu" required>
								階
							</td>
						</tr>
						<tr>
					...
					<table class="table table-bordered table-sm row-table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									棟名称
									<input type="text" name="editBuildingName__BuildingCD__" value="__BuildingName__" style="width:80px">
									&nbsp;
									住戸数(半角数字)
									<input type="number" name="editKosu__BuildingCD__" class="dwelling" value="__Kosu__" style="width: 80px; ime-mode: disabled" v-model="Kosu" required onchange="calcDwellingCount();">
									戸&nbsp;階高
									<input type="number" name="editKaidaka__BuildingCD__" class="buildingKaidaka" value="__Kaidaka__" style="width: 80px; ime-mode: disabled" v-model="Kosu" required>
									階
								</td>
							</tr>
							<tr>
								<th class="yb">作業期間</th>
								<td>
									<input type="text" name="editSenyuStartDate__BuildingCD__"  class="datepicker senyubucls" value="__BuildingSenyuStartDate__">～
									<input type="text" name="editSenyuEndDate__BuildingCD__"  class="datepicker senyubucls" value="__BuildingSenyuEndDate__">
								</td>
							</tr>
							<tr>
								<th class="yb">休工日</th>
  ...
  <div class="container">
	...
	$(function () {
		 $(".wHoliday").datepicker({
			numberOfMonths: 1,
/*			
			minDate: new Date($('input:text[name="SenyuStartDate"]').val()),
			maxDate: new Date($('input:text[name="SenyuEndDate"]').val()),
*/			
			showButtonPanel: true,
			closeText: '閉じる',
			currentText: '今日',
	...
	function addBuilding(){
		...
		var sHTML = '<table class="table table-bordered table-sm row-table">\
						...
						<tbody>\
							...
							<tr>\
								<th class="yb">棟名称・住戸数<font color="red">※</font></th>\
								<td>\
									棟名称\
									<input type="text" name="newBuilding[]" value="" style="width:80px">\
									&nbsp;\
									住戸数(半角数字)\
									<input type="number" class="dwelling" name="newKosu[]" value="" style="width: 80px; ime-mode: disabled" required onchange="calcDwellingCount();">\
									戸&nbsp;階高\
									<input type="number" name="newKaidaka[]"  class="buildingKaidaka" value="" style="width: 80px; ime-mode: disabled" required>\
									階\
								</td>\
							</tr>\
							<tr>\
								<th class="yb">作業期間</th>\
								<td>\
									<input type="text" name="newSenyuStartDate[]"  class="datepicker senyubucls" value="">～\
									<input type="text" name="newSenyuEndDate[]"  class="datepicker senyubucls" value="">\
								</td>\
							</tr>\
							<tr>\
								<th class="yb">休工日</th>\
