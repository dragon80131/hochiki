...
<body>
	...
	<div class="content-all2">
		...
		<div class="top-menu left-yose">
			...
			<form action="s_heya_matrix.php" method="POST">
...
<tr><td bgcolor="#CCFF99" >部屋番 ○○９を除外しますか？209など</td>
	<td><input type=checkbox name="Except9" value=1 >除外する</td></tr>-->
			...
			<table class="table table-bordered table-striped table-sm">
				<tr><td>部屋番号</td><td>名前</td><td>電話番号</td><td>対応メモ</td><td>前回実施日</td><td>編集</td><td>削除</td></tr>
				__HeyaLoop__
				<tr>
				<td>__ID__</td>
				<td>__LastName__</td>
				<td>__TEL__</td>
				<td>__Notes__</td>
				<td>__LastTimeFrom__</td>
				<td><a href=# onclick=javascript:__UserCD__  >編集</a></td>
				<td><a href=# onclick=javascript:__UserCD__  >削除</a></td>
				</tr>
				__HeyaLoop__
			</table>
