...
<body>
  ...
  <div class="content-all">
    ...
    <div id="app">
      ...
      <form action="s_date_finish2.php" method="POST" name="mainform" @submit.prevent="onSubmit">
            ...
            <tr>
              ...
              <td id="SagyouNittei">
                ...
                <div class="InputRows mb-2">
                  ...
                  <input type="text" name="wSagyoDates[]" value="" size=20 class="datepicker" autocomplete="off" v-model="date">
                </div>
