		...
		<div class="top-menu left-yose">
			...
			<form action="s_489_finish.php?rKey=__rKey__&editBukkenCD=__editBukkenCD__" method="POST">
				...
				<table class="table table-bordered table-sm">
					...
					<!--<tr><th>管理No</th><td>__KenmeiNo__</td></tr>-->
					<tr>
						<th>物件CD</th>
				...
				<table class="table table-bordered table-sm">
					...
					<!--<tr><th class="yb">オプション案内</th><td>__wwOPUketuke__</td></tr>-->
					<!--<tr><th class="yb" colspan="2">確定案内 記載社名</th><td>__wKakuteiCompanyName__</td></tr>-->
					<tr>
				...
				<table class="table table-bordered table-sm">
					...
					<!--<tr><th class="yb" rowspan="3">写真アプリ</th>-->
					<tr>
					...
					<!--
				<tr><th class="yb"　rowspan="2">工事完了確認書アプリ</th>
					<th class="yb">利用有無</th><td>__wwKakuninFlg__</td></tr>
				-->
					<tr>
						<th class="yb" rowspan="6">ポスティング</th>
						<th class="yb">利用有無</th>
						<td>__wwPostingFlg__</td>
					</tr>
					<!--
					<th class="yb">投函場所</th><td>__wwPostingBasho__</td></tr>
					<th class="yb">投函する案内</th><td>__wwPostType__ __wKeijiBasho__</td></tr>
					<th class="yb">腕章</th><td>__wwWanshoFlg__</td></tr>
					<th class="yb">管理員向け封書宛名</th><td>__wPostingName__</td></tr>
					<th class="yb">その他依頼事項</th><td>__wPostingBiko__</td></tr>
					<tr><th class="yb" colspan="2">スマートボード</th><td>__wwSmartFlg__</td></tr>
					-->
				</table>
				...
				<table class="table table-bordered table-sm">
					...
					<tr>
						...
						<td>
							<!--__GyosyaName1__--> __GyosyaTantoName1__
						</td>
					</tr>
					<tr>
						<th class="yb">施工業者担当者２</th>
						<td>
							<!--__GyosyaName2__--> __GyosyaTantoName2__
						</td>
					</tr>
					<tr>
						<th class="yb">施工業者担当者３</th>
						<td>
							<!--__GyosyaName3__--> __GyosyaTantoName3__
						</td>
					</tr>
					<tr>
						<th class="yb">施工業者担当者４</th>
						<td>
							<!--__GyosyaName4__--> __GyosyaTantoName4__
						</td>
					</tr>
					<tr>
						<th class="yb">施工業者担当者５</th>
						<td>
							<!--__GyosyaName5__--> __GyosyaTantoName5__
						</td>
					</tr>
					<tr>
						<th class="yb">施工業者担当者メモ</th>
						<td>
							<!--__GyosyaName5__--> __wGyosyaTantoMemo__
						</td>
					</tr>
				...
				<tr><th rowspan="10">オプション機器<br>販売価格</th>
					<td>01．__wOP1Name__　￥__wOPPrice1__</td></tr>
				<tr><td>02．__wOP2Name__　￥__wOPPrice2__</td></tr>
				<tr><td>03．__wOP3Name__　￥__wOPPrice3__</td></tr>
				<tr><td>04．__wOP4Name__　￥__wOPPrice4__</td></tr>
				<tr><td>05．__wOP5Name__　￥__wOPPrice5__</td></tr>
				<tr><td>06．__wOP6Name__　￥__wOPPrice6__</td></tr>
				<tr><td>07．__wOP7Name__　￥__wOPPrice7__</td></tr>
				<tr><td>08．__wOP8Name__　￥__wOPPrice8__</td></tr>
				<tr><td>09．__wOP9Name__　￥__wOPPrice9__</td></tr>
				<tr><td>10．__wOP10Name__　￥__wOPPrice10__</td></tr>
				-->
					<!--
				<tr><th>オプション支払方法</th><td>__wwShiharai__</td></tr>
				-->
					<tr>
						<th>1日の基本班体制数</th>
						<td>__wHansu__ 班</td>
					...
					<!--
				<tr><th>住戸工事期間中の休工日</th><td>__wKyukoDate__</td></tr>-->
					<tr>
						<th>工事期間中の集玄開錠方法</th>
						<td>__wwKaijyo__</td>
					</tr>
				...
				<input type="submit" value=" 予約センターへ依頼送信 " class="btn btn-primary">
			</form>
			...
			<form action="s_489.php?rKey=__rKey__&editBukkenCD=__editBukkenCD__" method="POST">
				__HiddenValues__
