    ...
    <div class="container text-left">
        <div class="row">
            <div class="col-12">
				...
				<a href="#" onclick="javascript:move('s_gyosya_detail.php?rKey=__rKey__')" class="btn btn-default sign-up">新規登録</a><br>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-12 mt-3">
				<form action="s_gyosya_list.php" name="mainform" method="POST">
					...
					<table class="table table-bordered table-sm table-striped">
						...
						__GyosyaListLoop__
						<tr>
							<td class="text-center"><input type="button" value="編集" class="btn btn-info btn-sm" onclick="javascript:moveWithGyosyaCD( 's_gyosya_detail.php?rKey=__rKey__', __GyosyaCD__  )"></td>
							<td>__GyosyaName__</td>
							<td>__GyosyaTEL__</td>
							<!--<td>__wGyosyaMail__</td> -->
							<td>__GyosyaNotes__</td>
							<td class="text-center"><input type="button" value="削除" class="btn btn-danger btn-sm" onclick="javascript:moveWithKeyAndWork10( 's_gyosya_list.php?rKey=__rKey__', __GyosyaCD__ , 2 )"></td>
						</tr>
						__GyosyaListLoop__
