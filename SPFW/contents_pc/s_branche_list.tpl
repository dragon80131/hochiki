...
<body>
    ...
    <div class="container text-left">
        <div class="row">
            <div class="col-12">
				...
				<a href="#" onclick="javascript:move('s_branche_detail.php?rKey=__rKey__')" class="btn btn-default sign-up">新規登録</a><br>
            </div>
        </div>
        <div class="row">
    ...
    <div class="container text-left">
        <div class="row">
            <div class="col-12 mt-3">
				<form action="s_branche_list.php" name="mainform" method="POST">
					<input type="hidden" name="editBrancheCD" value="">
					...
					<table class="table table-bordered table-sm table-striped">
						...
						__BrancheListLoop__
						<tr>
							<td class="text-center"><input type="button" value="編集" class="btn btn-info btn-sm" onclick="javascript:moveWithBrancheCD( 's_branche_detail.php?rKey=__rKey__', __BrancheCD__  )"></td>
							<td>__BrancheName__</td>
							<td>__BrancheTEL__</td>
							<td class="text-center"><input type="button" value="削除" class="btn btn-danger btn-sm" onclick="javascript:moveWithKeyAndWork12( 's_branche_list.php?rKey=__rKey__', __BrancheCD__ , 2 )"></td>
						</tr>
						__BrancheListLoop__
