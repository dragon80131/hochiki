...
<font size="+1">__Today__</font><br><br>
...
<hr size="__HRSize__" color="gray">
	...
	<h3>４．変更割合等</h3>
	<table width="700">
	<tr><td colspan="3">①予約センターに連絡のあった戸数</td></tr>
	...
	<tr><td colspan="3">③電話／WEB受付割合</td</tr>
	<tr><td>　</td>
	...
	<tr>
		...
		<td colspan="2">
			<table border=1 cellspacing="0" bordercolor="#505050">
				...
				__dispMenuLoop__
					<td align="center" bgcolor="#FFDDFF" width="90">__dispMenuName__</td>
				__dispMenuLoop__
				</tr>
				<tr>
				__dispMenuLoop2__
					<td align="center">__dispMenutCount__</td>
				__dispMenuLoop2__
				</tr>
			</table>
