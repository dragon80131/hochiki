...
function MoveandCheck(page){
	...
	if(frm.wKokiStart.value == "0000-00-00"){
		ErrorFlg = 1;
...
*/	}
	if(frm.wKokiEnd.value == "0000-00-00"){
		ErrorFlg = 1;
...
function ringiconfirm(){

	
	if(document.getElementById( "Tokuisaki" ).value == "2"){
		if('__SonotaFlg__'==true){
			document.getElementById('ringialert').innerHTML="<font color='red'>※その他口座販売稟議申請を行って下さい。</font>";
		}else{
			document.getElementById('ringialert').innerHTML="";
		}
	}else{
		document.getElementById('ringialert').innerHTML="";
	}
...
物件CD：__editBukkenCD__　物件名：__BukkenName__<br>
所属：__SitenName__<br><br>
...
<font color="blue">__Strings__<br></font>
...
<tr><th>工事名</th>
	<td>
		<input type="text" name="wKojiName" value="__wKojiName__" style="width:450px; background-color: #FFF0F5;">
...
<tr><th>請負金額：<font color="red">税金（消費税は10％）</font></th>
...
<tr><th>（注文者の）組織種類</th>
	<td>
		<input type="text" name="wSosikiType" list="wSosikiTypeList" value="__wSosikiType__" size="15">
...
<tr><th>（注文者の）組織名</th>
	<td>
		<input type="text" name="wSosiki" style="width:450px" value="__wSosiki__">
		<br>※組合名など
	</td>
</tr>
...
<tr><th>通数</font></th>
	<td>
		<select name="wTusu" id="Tusuid" >
			<option value="">-</option>
			<option value="1" __wTusuSelected1__>1</option>
			<option value="2" __wTusuSelected2__>2</option>
		</select>
		通
	</td>
</tr>
...
<tr><th>得意先コード</th>
	<td>
		<select name="wTokuisakiCD" id="Tokuisaki"  onchange="ringiconfirm()">
			<option value="">-</option>
			<option value="1" __TokuisakiSelected1__>有</option>
			<option value="2" __TokuisakiSelected2__>無</option>
		</select>
		<span id="ringialert">__RingiAlert__</span>
	</td>
</tr>

</table>
<br>
<input type="button" value="登録" onclick="moveWithWork('s_keiyakusho.php',1)" class="btn btn-primary">
<br><br>
<input type="button" value="契約書を作成する" onclick="MoveandCheck('./doc/s_keiyakusho_Excel.php')" class="btn btn-primary">
</form>
