...
<body bgcolor="__SBackground__" text="__STextColor__" link="__SLinkColor__" alink="__SALinkColor__" vlink="__SVLinkColor__">
	...
	<div class="content-all">
		...
		<form action="s_make_kanryohayashi.php" method="POST" name="mainform">
...
<tr><td>　</td>
	<td colspan=4 >
		...
		編集するもしくは、予約受付センターにご相談ください。　
			...
			<input type="button" value="確定" class="btn btn-primary" onclick="moveandCheck('s_make_kanryohayashi.php')">
			<br><br>
