	...
	<script>
		...
		function checkmove(page) {
			...
			if (frm.wWakuPattern.value <= 2) {
				...
				if (frm.wWakuAM.value == "" || frm.wWakuAM2.value == "" || frm.wWakuAM3.value == "" || frm.wWakuAM4.value == "" || frm.wWakuPM1.value == "" || frm.wWakuPM2.value == "" || frm.wWakuPM3.value == "" || frm.wWakuPM4.value == "" || frm.wWakuPM5.value == "" || frm.wWakuPM6.value == "") {
					document.getElementById("WakuAMPMError").innerHTML = "※最大工事枠数が入力されていません";
					error_flg = "1";
				} else if (frm.wWakuAM.value < 1 || frm.wWakuAM2.value < 1 || frm.wWakuAM3.value < 1 || frm.wWakuAM4.value < 1 || frm.wWakuPM1.value < 1 || frm.wWakuPM2.value < 1 || frm.wWakuPM3.value < 1 || frm.wWakuPM4.value < 1 || frm.wWakuPM5.value < 1 || frm.wWakuPM6.value < 1) {
					document.getElementById("WakuAMPMError").innerHTML = "※入力内容が正しくありません";
					error_flg = "1";
				} else {
					document.getElementById("WakuAMPMError").innerHTML = "";
						...
						<td><br>
							<table>
								<tr>
									...
									<td>
										<span id="a4" __a4style__>　AM4<input type="number" name="wWakuAM4" value="__wWakuAM4__" style="width:50px;" min="1" id="wakuam4"></span>
									</td>
									<td>
									...
									<td>
										<span id="p5" __p5style__>　PM5<input type="number" name="wWakuPM5" value="__wWakuPM5__" style="width:50px;" min="1" id="wakupm5"></span>
									</td>
									<td>
										<span id="p6" __p6style__>　PM6<input type="number" name="wWakuPM6" value="__wWakuPM6__" style="width:50px;" min="1" id="wakupm6"></span>
									</td>
								</tr>
							</table>
...
<input type="hidden" name="Except9" value=1 >-->
				<input type="hidden" name="rKey" value="__rKey__">
				<br>
				<input type="button" class="btn btn-primary" onclick="javascript:checkmove('s_make_kotei_confirmhayashi.php?editBukkenCD=__editBukkenCD__' )" value="工程表案表示">
				<hr>
				<hr>
...
<input type="button" value="Excel日程データ読み込み" onclick="modorumove('d_csvUpload.php?editBukkenCD=__editBukkenCD__');" class="btn btn-primary"><br> -->
				...
				<input type="button" value="日程データ削除" onclick="sakuzyo(2,'s_make_kanryohayashi.php?rKey=__rKey__&editBukkenCD=__editBukkenCD__');" class="btn btn-primary">
				<br>
