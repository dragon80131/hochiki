 ...
 <br> 
			...
			<form action="s_make_schedule.php" method="POST" name="mainform">
				<table border=1>
					...
					<tr><td>専有部期間（開始日）</td><td><input type="text" name="wSenyuStartDate" value="__wSenyuStartDate__" class="datepicker" style="width:120px;" > </td></tr>
					<tr><td>専有部期間（終了日）</td><td><input type="text" name="wSenyuEndDate" value="__wSenyuEndDate__" class="datepicker" style="width:120px;" > </td></tr>
...
<input type="hidden" name="Except9" value=1 >-->
				...
				<br>
				<input type="button" class="btn btn-primary blue" onclick="javascript:checkmove('s_make_kanryo_hensyu.php?editBukkenCD=__editBukkenCD__' )" value="工程表案表示">
				<br>
