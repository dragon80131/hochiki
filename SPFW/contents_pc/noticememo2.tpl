...
<body bgcolor="__SBackground__" text="__STextColor__" link="__SLinkColor__" alink="__SALinkColor__" vlink="__SVLinkColor__">
	...
	<form method="POST" action="noticememo2.php?rKey=__rKey__" name="mainform" class="noticememo">
		...
		<table class="noticeTable" width="60%">
			...
			<tr>
				...
				<td width="1%">
					<input type="button" value="削除" class="button" onclick="javascript:moveWithNoticeKeyAlert('noticememo2.php', '__NoticeCD__', '2')">
				</td>
			</tr>
			__MemoLoop__
		</table>
	...
	<form action="noticememo2.php?rKey=__rKey__" method="post" enctype="multipart/form-data" name="mainform">
		<input type="file" name="kojiupload" id="kojiupload" accept="*.*">
	...
	__fileLoop__
	__fileList__
	<form action="noticememo2.php?rKey=__rKey__" method="post">
		<input type="hidden" name="work" value="4">
		<input type="hidden" name="filepath_del2" value="__filepath_del__">
