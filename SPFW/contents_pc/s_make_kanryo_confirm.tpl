...
<form action="s_make_schedule.php" method="POST" name="mainform" ><!--mainform-->
<table border=1 >
...
<tr><td bgcolor="#CCFF99" >工事順<br>(詳細工程表の並び順</td>
	...
	<table>
	<tr><td align=right ><img src="__KojijunImg__" width="50">__KojijunDisp__
		</td>
	</tr>
	</table>
...
<table>
	<tr>
		<td style="width:200px">
			<input type="submit" class="btn btn-primary" onclick="javascript:move('s_make_kotei_EXCEL.php?editBukkenCD=__editBukkenCD__' )" value="詳細工程表作成" __SakuseiDisabled__>
		</td>
		<td>
			<input type="submit" class="btn btn-primary" onclick="javascript:move('s_make_kanryo_hensyu.php?editBukkenCD=__editBukkenCD__' )" value="編集">
		</td>
		<!--<td>
