...
<a href="#" onclick="javascript:move('s_sagyoin_detail.php?rKey=__rKey__')">＞＞＞　新規登録</a> <br>
...
<td>__Sa002__</td>
<td>__Sa001__</td>
<td><input type="button" value="編集" class="button" onclick="javascript:moveWithSagyoinCD( 's_sagyoin_detail.php?rKey=__rKey__', __SagyoinCD__  )"></td>
<td><input type="button" value="削除" class="button" onclick="javascript:moveWithKeyAndWork3( 's_sagyoin_list.php?rKey=__rKey__', __SagyoinCD__ , 2 , __SagyoinCD__ )"></td>
</tr>
__SagyoinListLoop__
