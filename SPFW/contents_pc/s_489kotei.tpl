...
<tr><td bgcolor="#dcf8f8">マンション名</td>
	<td width="300">__MansionName__</td></tr>
...
工事写真や複雑な物件を確認する場合は、作業工程表<a href="https://www2.489501.jp/__BukkenCD489__/" target="_blank">こちら</a>をご覧ください。
<Div Align='left'>
<table>
<tr><td>
...
<table table-layout: fixed class="table table-bordered table-sm">
<tr align="center" >
	<td colspan=__colspan__ bgcolor="#dcf8f8" >共有部工事日 __KyoyuStartDate__ ～ __KyoyuEndDate__</td></tr>
<tr align="center" bgcolor="#dce0f5">
	<td>完了</td><td>受付</td><td>変更</td><td>部屋</td>
