...
<form name="form1" method="POST" action="./doc/s_rakutouchkikisetei_finish.php?rKey=__rKey__" >
<h6>らくタッチPlus</h6>
...
◆<a href="s_rakutouchkiki_copy.php?rKey=__rKey__&editBukkenCD=__editBukkenCD__">過去の案件の機器情報をコピーする</a>
