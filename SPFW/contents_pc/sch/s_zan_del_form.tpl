...
<tr><td>作業分類</td><td>__wZanMenuCD__</td></tr>
...
<input type=submit value = "削　除" class="btn btn-primary" >
<br>★すぐ削除されます。
</form>
...
<form action="s_zan_edit_form.php" method="POST">
<input type=hidden name="rKey" value="__rKey__">
<input type=hidden name="editZanSagyoGroupCD" value="__editZanSagyoGroupCD__">

<input type=submit value = "編　集" class="btn btn-primary" >
<br>　　
</form>
