...
<a href="s_smartreport_search.php__QUERY__">＜＜　スマレポ検索</a><br>
</div>

<form action="s_smartreport_sitenlist.php?rKey=__rKey__" method="POST">
<table border="1" class="table" style="width:400px;font-size:80%">
<tr><th class="ptb5">支店</th><th class="ptb5">都道府県</th></tr>
<tr><td class="ptb2"><input type="radio" name="radio_pref" value="札幌">札幌　</td><td class="ptb2">北海道</td></tr>
<tr><td class="ptb2"><input type="radio" name="radio_pref" value="北関東">北関東</td><td class="ptb2">埼玉県</td></tr>
<tr><td class="ptb2"><input type="radio" name="radio_pref" value="東京">東京　</td><td class="ptb2">東京都</td></tr>
<tr><td class="ptb2"><input type="radio" name="radio_pref" value="横浜">横浜　</td><td class="ptb2">神奈川県</td></tr>
<tr><td class="ptb2"><input type="radio" name="radio_pref" value="名古屋">名古屋</td><td class="ptb2">愛知県</td></tr>
<tr><td class="ptb2"><input type="radio" name="radio_pref" value="大阪">大阪　</td><td class="ptb2">大阪府・京都府・奈良県・和歌山県・兵庫県</td></tr>
<tr><td colspan="2"><input type="submit" class="btn btn-primary btn-sm" value="表示"></td></tr>
</table>
