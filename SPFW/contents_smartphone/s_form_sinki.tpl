...
<head>
	...
	<script>
		...
		// // 基本システムのselect選択と連動して、親機と子機のselectの中身を変更する
		// $(function () {
		// 	//changeを使って、プルダウンの変更をトリガーとする
		// 	$("#BasicSystems").on('change', function () {
		// 		var BasicSystemsVal = $(this).val();
		// 		$.ajax({
		// 			type: "POST", //デフォルトをPOSTに指定
		// 			dataType: "json",
		// 			url: "./getBasicSystems.php",
		// 			data: {
		// 				"BasicSystem": BasicSystemsVal
		// 			}
		// 		}).done(function (data) {
		// 			console.log(data);
		// 			$("#OyaKataban").html(data[0]);
		// 			$("#KokiKataban").html(data[1]);
