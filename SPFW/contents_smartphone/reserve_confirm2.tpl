...
<input type="text" name="wAddress3" value="__wAddress3__" istyle="1"><br>
...
<center><a href="logout.php__QUERY__">■ログアウト</a><br></center>
</form>
__SFooter__
<hr size="__HRSize__" color="__HRColor__">
__SCopyright__
