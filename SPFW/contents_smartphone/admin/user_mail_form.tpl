<html>
<head>
<title>会員管理 − システム設定 − 完了メール(__Name__)設定フォーム</title>
...
<body>
<div class="content">
<h2 class="admin-title">会員管理 − システム設定 − メール(__Name__)設定フォーム__ExtraTitle__</h2>
<br />
...
__IfEdit__	<tr id="blockAction">
		<td nowrap class="common-list-value-left" colspan="2">
			<input type="button" value="新規登録時の登録完了メール設定をコピー" class="button" onclick="javascript:moveWithWork('user_mail_form.php', 1)">
		</td>
	</tr>
__IfEdit__
	<tr>
...
<!--			<select onChange="javascript:putSelectedItem(this, 'Message2')">
	...
	<tr id="blockAction">
		<td nowrap class="common-list-value-left" colspan="2">
			<input type="button" value="データ更新" class="button" onclick="javascript:move('user_mail_end.php')">　
