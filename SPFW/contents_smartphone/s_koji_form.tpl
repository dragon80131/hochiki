...
function ChechAndMove(url){
	var error_flg="";
	//1行目のチェック
	if(document.getElementsByName("wOP1DeviceCD")[0].value!="") {	//機器名称がある
	...
	//2行目のチェック
	if(document.getElementsByName("wOP2DeviceCD")[0].value!="") {
	...
	//3行目のチェック
	if(document.getElementsByName("wOP3DeviceCD")[0].value!="") {
	...
	//4行目のチェック
	if(document.getElementsByName("wOP4DeviceCD")[0].value!="") {
	...
	//5行目のチェック
	if(document.getElementsByName("wOP5DeviceCD")[0].value!="") {
	...
	//6行目のチェック
	if(document.getElementsByName("wOP6DeviceCD")[0].value!="") {
	...
	//7行目のチェック
	if(document.getElementsByName("wOP7DeviceCD")[0].value!="") {
	...
	//8行目のチェック
	if(document.getElementsByName("wOP8DeviceCD")[0].value!="") {
	...
	//9行目のチェック
	if(document.getElementsByName("wOP9DeviceCD")[0].value!="") {
	...
	//10行目のチェック
	if(document.getElementsByName("wOP10DeviceCD")[0].value!="") {
...
<tr><th class="yb">所属名</th>
	<td><input type="text" name="wKojiShozokuName"  style="width:300px;background-color:#FFF0F5;" value="__wKojiShozokuName__" ></td></tr>
<tr><th class="yb">担当名</th>
	<td><input type="text" name="wKojiTantoName" style="width:300px;background-color:#FFF0F5;" value="__wKojiTantoName__" ></td></tr>
</table>
<br>
...
<tr><th class="yb_nowrap">施工主体</th >
	<td  colspan="3" bgcolor=#FFF0F5>
		...
		<input type="radio" name="wSekoShutaiOP" value="0" __SekoShutaiChecked0__ onchange="changeSekoShutaiOP();"  >元請け　
		<input type="radio" name="wSekoShutaiOP" value="1" __SekoShutaiChecked1__ onchange="changeSekoShutaiOP();"  >下請け　
...
<tr><th colspan="2" class="yb">全体工期</th>
	<td colspan="7">
		<input type="text" name="wZentaiStartDate" value="__wZentaiStartDate__" class="datepicker" style="width:120px;background-color:#FFF0F5;" readonly>
		～
		<input type="text" name="wZentaiEndDate" value="__wZentaiEndDate__" class="datepicker" style="width:120px;background-color:#FFF0F5;" readonly>
	</td>
</tr>
<tr><th colspan="2" class="yb">共用部</th>
	<td colspan="7">
		<input type="text" name="wKyoyoStartDate" value="__wKyoyoStartDate__" class="datepicker" style="width:120px;background-color:#FFF0F5;" readonly>
		～
		<input type="text" name="wKyoyoEndDate" value="__wKyoyoEndDate__" class="datepicker" style="width:120px;background-color:#FFF0F5;" readonly>
	</td>
</tr>
<tr><th colspan="2" class="yb">専有部</th>
	<td colspan="7">
		<input type="text" name="wSenyuStartDate" id="senyubustart" value="__wSenyuStartDate__" class="senyubucls" style="width:120px;background-color:#FFF0F5;"  readonly>
		～
		<input type="text" name="wSenyuEndDate" id="senyubuend" value="__wSenyuEndDate__" class="senyubucls" style="width:120px;background-color:#FFF0F5;" readonly>
	</td>
</tr>
<tr><th colspan="2" class="yb">予備日</th>
	<td colspan="7">
		<input type="text" name="wYobiStartDate" value="__wYobiStartDate__" class="datepicker" style="width:120px" readonly>
		～
		<input type="text" name="wYobiEndDate" value="__wYobiEndDate__" class="datepicker" style="width:120px" readonly>
	</td>
</tr>
...
<tr><th class="yb">暗証番号</th>
	...
	<td id="idZumenwatasiDate" >

<tr><th class="yb">住民様ご案内用暗証番号</th>
	<td id="IDwAnshoNoKojichu" style="color:__wAnshoNoKojichuColor__">呼出ボタン＋（数字4桁）<input type="text" maxlength="4" name="wAnshoNoKojichu" value="__wAnshoNoKojichu__" style="width:80px;ime-mode:" __wAnshoNoKojichuDisabled__>
		<br><font size="2" color="gray">4桁で記入してください。記入例）2019</td>
</tr>
</table>
<br>
